...
Page({
  ...
  showRequire: function (e) {
    var brd_id = e.currentTarget.dataset.brd_id
      var brd_name = e.currentTarget.dataset.brd_name
    console.log(brd_id)
    console.log(brd_name)
    wx.redirectTo({
      url: '../edit_chexing/edit_chexing?brd_id=' + brd_id+'&&brd_name='+brd_name+'&&color='+this.data.color+'&&carNo='+this.data.carNo+'&&carId='+this.data.carId
    })
  },
  onLoad: function (options) {
    ...
    wx.request({
      ...
      data: { "params": { "brandMethod": "brand", "brdId": "", "cscId": "" } },
      method: 'POST',
      header: {
